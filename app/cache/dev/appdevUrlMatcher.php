...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/backcon/parametres/general')) {
            // parametres_general
            ...
            if ($pathinfo === '/backcon/parametres/general/utilisateurs') {
                return array (  '_controller' => 'Backcon\\Parametres\\GeneralBundle\\Controller\\UtilisateursController::indexAction',  '_route' => 'parametres_general_utilisateurs',);
            }

            // parametres_general_utilisateurs_lister
            if (0 === strpos($pathinfo, '/backcon/parametres/general/utilisateurs/lister') && preg_match('#^/backcon/parametres/general/utilisateurs/lister(?:/(?P<max>[^/]+?))?$#xs', $pathinfo, $matches)) {
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Backcon\\Parametres\\GeneralBundle\\Controller\\UtilisateursController::listerAction',  'max' => 15,)), array('_route' => 'parametres_general_utilisateurs_lister'));
            }

            // parametres_general_utilisateurs_nouveau
            if ($pathinfo === '/backcon/parametres/general/utilisateurs/nouveau') {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_parametres_general_utilisateurs_nouveau;
                }
                return array (  '_controller' => 'Backcon\\Parametres\\GeneralBundle\\Controller\\UtilisateursController::ajouterAction',  '_route' => 'parametres_general_utilisateurs_nouveau',);
            }
            not_parametres_general_utilisateurs_nouveau:

            // parametres_general_utilisateurs_supprimer
            if ($pathinfo === '/backcon/parametres/general/utilisateurs/supprimer') {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_parametres_general_utilisateurs_supprimer;
                }
                return array (  '_controller' => 'Backcon\\Parametres\\GeneralBundle\\Controller\\UtilisateursController::supprimerAction',  '_route' => 'parametres_general_utilisateurs_supprimer',);
            }
            not_parametres_general_utilisateurs_supprimer:

            // parametres_general_utilisateurs_etat
            if ($pathinfo === '/backcon/parametres/general/utilisateurs/etat') {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_parametres_general_utilisateurs_etat;
                }
                return array (  '_controller' => 'Backcon\\Parametres\\GeneralBundle\\Controller\\UtilisateursController::etatAction',  '_route' => 'parametres_general_utilisateurs_etat',);
            }
            not_parametres_general_utilisateurs_etat:

        }

        if (0 === strpos($pathinfo, '/backcon/parametres/congres')) {
            // parametres_congres
            ...
            // parametres_congres_avance
            if ($pathinfo === '/backcon/parametres/congres/avance') {
                return array (  '_controller' => 'Backcon\\Parametres\\CongresBundle\\Controller\\DefaultController::avanceAction',  '_route' => 'parametres_congres_avance',);
            }
