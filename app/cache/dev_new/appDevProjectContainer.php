...
class appDevProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:\\wamp\\www\\backcon\\Symfony\\app/cache/dev_new/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $a = $this->get('templating.loader');
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('C:\\wamp\\www\\backcon\\Symfony\\app/cache/dev_new/assetic/config'), false)));
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $g->setProxyDir('C:\\wamp\\www\\backcon\\Symfony\\app/cache/dev_new/doctrine/orm/Proxies');
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\SqliteProfilerStorage('sqlite:C:\\wamp\\www\\backcon\\Symfony\\app/cache/dev_new/profiler.db', '', '', 86400), $a);
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => 'php', 'translation.loader.yml' => 'yml', 'translation.loader.xliff' => 'xliff'), array('cache_dir' => 'C:\\wamp\\www\\backcon\\Symfony\\app/cache/dev_new/translations', 'debug' => false), $this->get('session'));
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => 'C:\\wamp\\www\\backcon\\Symfony\\app/cache/dev_new/twig', 'charset' => 'UTF-8'));
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:\\wamp\\www\\backcon\\Symfony\\app/cache/dev_new/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:\\wamp\\www\\backcon\\Symfony\\app/cache/dev_new');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:\\wamp\\www\\backcon\\Symfony\\app/cache/dev_new',
            ...
            'profiler.storage.dsn' => 'sqlite:C:\\wamp\\www\\backcon\\Symfony\\app/cache/dev_new/profiler.db',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:\\wamp\\www\\backcon\\Symfony\\app/cache/dev_new/twig',
                'charset' => 'UTF-8',
            ),
            ...
            'doctrine.orm.proxy_dir' => 'C:\\wamp\\www\\backcon\\Symfony\\app/cache/dev_new/doctrine/orm/Proxies',
            ...
            'assetic.cache_dir' => 'C:\\wamp\\www\\backcon\\Symfony\\app/cache/dev_new/assetic',
