...
class __TwigTemplate_a6541473f218e9b39d3afac5aef3b61e extends Twig_Template
{
...
<div class=\"sf-toolbarreset\"
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["name"] => $context["template"]) {
            ...
            echo twig_escape_filter($this->env, $this->getAttribute($_template_, "renderblock", array("toolbar", array("collector" => $this->getAttribute($_profile_, "getcollector", array($_name_, ), "method"), "profiler_url" => $_profiler_url_, "token" => $this->getAttribute($_profile_, "token"), "name" => $_name_, "verbose" => $_verbose_), ), "method"), "html", null, true);
            // line 35
            echo "
    ";
        }
