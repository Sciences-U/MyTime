...
class __TwigTemplate_89b48db3b91a4ebdec5e693a50a50382 extends Twig_Template
{
    ...
    ");
        ...
        echo twig_escape_filter($this->env, sprintf("%.0f", ($this->getAttribute($_collector_, "time") * 1000)), "html", null, true);
        echo " ms
    ";
