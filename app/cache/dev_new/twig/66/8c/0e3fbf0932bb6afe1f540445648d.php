...
class __TwigTemplate_668c0e3fbf0932bb6afe1f540445648d extends Twig_Template
{
    ...
    ";
        ...
        if ($this->getAttribute($_collector_, "logs")) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["log"]) {
                ...
                if ((("ERR" == $this->getAttribute($_log_, "priorityName")) || ("ERROR" == $this->getAttribute($_log_, "priorityName")))) {
                    echo " error";
                }
                echo "\">
                    ";
